  ...
  var navigation = {
    ...
    closeAccordions: function(button, section) {
      ...
      $('.accordion .button-chapter').each(function(index, element) {
        ...
        toggle.children('.group-heading').removeClass('active').find('.icon').addClass('fa-caret-right').removeClass('fa-caret-down');
    ...
    openAccordion: function(button, section) {
      ...
      buttonEl.children('.group-heading').addClass('active').find('.icon').removeClass('fa-caret-right').addClass('fa-caret-down');
