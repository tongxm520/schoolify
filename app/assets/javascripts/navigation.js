...
Navigation = (function() {
  var navigation = {
    ...
    listenForClick: function() {
      $('.accordion').on('click', '.button-chapter',
      function(event) {
    ...
    listenForKeypress: function() {
      $('.accordion').on('keydown', '.button-chapter',
      function(event) {
    ...
    closeAccordions: function(button, section) {
      ...
      $('.accordion .button-chapter').each(function(index, element) {
        ...
        toggle.children('.group-heading').removeClass('active').find('.chapter-fa').addClass('ion-arrow-right-b').removeClass('ion-arrow-down-b');

        toggle.next('.chapter-content-container').removeClass('is-open').find('.chapter-menu').not(menu).removeClass('is-open').slideUp();
      });
    },
    ...
    openAccordion: function(button, section) {
      ...
      buttonEl.children('.group-heading').addClass('active').find('.chapter-fa').removeClass('ion-arrow-right-b').addClass('ion-arrow-down-b');

      sectionEl.addClass('is-open').find('.chapter-menu').addClass('is-open').slideDown();
    }
  };
